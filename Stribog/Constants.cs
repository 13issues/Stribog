...
namespace Stribog
{
    internal static class Constants
    {
        ...
        // Массив для P-преобразования || больше не нужен, т.к. заменил на простое транспонирование квадратной матрици

        // Массив для L-преобразования
        internal static readonly ulong[] A = {
        ...
        internal static readonly byte[] C = {
