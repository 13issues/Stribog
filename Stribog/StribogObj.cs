...
namespace Stribog
{
    ...
    public class StribogObj
    {
        ...
        /// <summary>
        /// Хеширует входную строку, представленную в виде массива байт, и возвращает хеш-код в виде строки символов, 
        /// преобразуя числовое значение каждого байта результирующего массива в эквивалентное ему шестнадцатеричное строковое представление
        /// </summary>
        ...
        /// <summary>
        /// Хеширует входную строку, представленную в виде массива байт, и возвращает хеш-код в виде массива байт 
        /// </summary>
        /// <param name="message">Входная строка</param>
